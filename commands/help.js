module.exports = {
  ...
  execute(Discord, message, args) {
    ...
    const AVAILABLE_FULL =
      "Searches the guild for all **available** and **unavailable** members by role(s). Use `!keeper available-who <TAGNAME(S)>`. Can handle multiple queries. Case insensitive. Searches for Role (ex. Paladin) OR profession (BackEndDev).";
